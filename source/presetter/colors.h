...
#define FILTER_GRID_EMPTY_CELL_STROKE_COLOR (p_color){COLOR_SYM, "#555555"}
...
#define FILTER_GRID_EMPTY_TEXT_COLOR (p_color){COLOR_SYM, "#555555"}
...
#define FILTER_GRID_EMPTY_CIRCLE_COLOR (p_color){COLOR_SYM, "#555555"}
